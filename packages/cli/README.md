...
running command...
$ nf (--version)
@node-flow/cli/0.0.1-alpha.8 linux-x64 node-v16.14.2
$ nf --help [COMMAND]
USAGE
  $ nf COMMAND
...
...
_See code: [dist/commands/flow/index.js](https://github.com/WayneGongCN/hello-world/blob/v0.0.1-alpha.8/dist/commands/flow/index.js)_
